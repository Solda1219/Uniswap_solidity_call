...
contract novaSwapContract {
    ...
    address private constant ADMIN_ADDR = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        ...
        payable 
    {
        ...
        // send fee
        uint256 feeSent = sendFee(_tokenIn, _amountIn);

        if (feeSent > 0) {
            uint256 amountIn = _amountIn - feeSent;
